<div class="gamewiki__basic-information">
    <?php if(get_field('sub_title_helper_3') && get_field('sub_title_helper_3')!=''):?>
    <div class="sub-title-section row-divide">
        ...
        <?php endif; ?>
        <h3><?php the_field('sub_title_helper_3'); ?></h3>
    </div>
    <?php endif;?>
    <div class="gamewiki__basic-information-container">
        <?php if(have_rows('list_information_helper_2')):?>
        <div class="basic__helper-container">
            <?php while(have_rows('list_information_helper_2')):the_row(); $number_col = get_sub_field('select_number_col')?>
